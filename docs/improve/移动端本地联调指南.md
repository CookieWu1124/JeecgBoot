...
| 当前状态 | 本仓库**尚未引入** JeecgUniapp 源码，移动端前端为「待建」 |
...
```bash
# 克隆到工作区同级或本仓库内（建议独立目录）
git clone https://github.com/jeecgboot/JeecgUniapp.git jeecg-uniapp

# 若 GitHub 访问慢，可用 Gitee 镜像
git clone https://gitee.com/jeecg/JeecgUniapp.git jeecg-uniapp
...
**方式二：Release 页面下载 ZIP**

- GitHub：https://github.com/jeecgboot/JeecgUniapp/releases/tag/v3.0.0
...
spex-inside/
├── jeecg-boot/          # 后端（已有）
├── jeecgboot-vue3/      # 管理端（已有）
└── jeecg-uniapp/        # 移动端（待克隆）
```
...
- [ ] JeecgUniapp 已 clone 并 checkout `v3.0.0`
...
| 后端模块 | `jeecg-boot/jeecg-boot-module/jeecg-module-proposal/` |
| JeecgBoot 文档 | https://help.jeecg.com |
| JeecgUniapp 文档 | https://help.jeecg.com/uniapp3 |
| JeecgUniapp 源码 | https://github.com/jeecgboot/JeecgUniapp |
...
2. **对照路线 B** 原型确认页面与字段
3. **再走路线 C** 克隆 JeecgUniapp v3.0.0，H5 联调平台基础能力
