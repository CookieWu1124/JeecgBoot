...
public class JwtUtil {
    ...
    public static Map<String, String> parseToken(String token) {
        try {
            ...
            map.put("workNo", jwt.getClaim("workNo").asString());
            map.put("realName", jwt.getClaim("realName").asString());
            map.put("orgCode", jwt.getClaim("orgCode").asString());
            map.put("departName", jwt.getClaim("departName").asString());
            return map;
